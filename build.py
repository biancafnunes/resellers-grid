...
# niveis_detail.json — subidas e quedas de nível
_TRANS_SUBIDAS = {"Aprendiz -> Especialista","Especialista -> Empreendedor","Empreendedor -> Top Empreendedor","Especialista -> Top Empreendedor"}
niveis_raw = []
try:
    with open(r'C:\Users\daviaraujo\resellers-grid\niveis_detail.json', encoding='utf-8') as f:
        niveis_raw = json.load(f)
except FileNotFoundError:
    pass
subidas_list = [r for r in niveis_raw if r.get('transicao') in _TRANS_SUBIDAS]
quedas_list  = [r for r in niveis_raw if r.get('transicao') not in _TRANS_SUBIDAS]
subidas_json = json.dumps(subidas_list, ensure_ascii=False)
quedas_json  = json.dumps(quedas_list,  ensure_ascii=False)
_meses_niveis = sorted(set(r['dt'][:7] for r in niveis_raw if r.get('dt')))
meses_niveis_js = json.dumps(_meses_niveis)
_mes_label_map = {"2026-01":"Jan/26","2026-02":"Fev/26","2026-03":"Mar/26","2026-04":"Abr/26","2026-05":"Mai/26","2026-06":"Jun/26","2026-07":"Jul/26","2026-08":"Ago/26","2026-09":"Set/26","2026-10":"Out/26","2026-11":"Nov/26","2026-12":"Dez/26"}
_niveis_periodo = f"{_mes_label_map.get(_meses_niveis[0],_meses_niveis[0])}–{_mes_label_map.get(_meses_niveis[-1],_meses_niveis[-1])}" if _meses_niveis else "—"
...
<div class="pane" id="pane-niveis">
  ...
  <div id="view-quedas" style="display:none">
    ...
    <div class="chart-wrap">
      ...
      <div class="chart-sub">Quantidade de resellers que caíram de nível — """ + _niveis_periodo + """</div>
...
const RAW = [
  ...
  {mes:"Jun/26",nivel:"Aprendiz",        resellers:498,  pedidos:924, ativos:1301, tpv_m0:1732232,  tpv_m1:3630276,  tpv_total:18913427,  pedidos_pro:839,  pedidos_smart:85, ativos_pro:1182,   ativos_smart:119},
  {mes:"Jun/26",nivel:"Especialista",        resellers:85,  pedidos:755, ativos:414, tpv_m0:894620,  tpv_m1:2275000,  tpv_total:10327000,  pedidos_pro:728,  pedidos_smart:27, ativos_pro:399,   ativos_smart:15},
  {mes:"Jun/26",nivel:"Empreendedor",        resellers:42,  pedidos:569, ativos:368, tpv_m0:1008220,  tpv_m1:2877059,  tpv_total:13199124,  pedidos_pro:479,  pedidos_smart:90, ativos_pro:310,   ativos_smart:58},
  {mes:"Jun/26",nivel:"Top Empreendedor",        resellers:33,  pedidos:731, ativos:726, tpv_m0:1486826,  tpv_m1:4735884,  tpv_total:26200415,  pedidos_pro:625,  pedidos_smart:106, ativos_pro:621,   ativos_smart:105},
  {mes:"Jul/26",nivel:"Aprendiz",        resellers:0,  pedidos:0, ativos:0, tpv_m0:0,  tpv_m1:259257,  tpv_total:1368854,  pedidos_pro:0,  pedidos_smart:0, ativos_pro:0,   ativos_smart:0},
  {mes:"Jul/26",nivel:"Especialista",        resellers:0,  pedidos:0, ativos:0, tpv_m0:0,  tpv_m1:116700,  tpv_total:756808,  pedidos_pro:0,  pedidos_smart:0, ativos_pro:0,   ativos_smart:0},
  {mes:"Jul/26",nivel:"Empreendedor",        resellers:0,  pedidos:0, ativos:0, tpv_m0:0,  tpv_m1:210308,  tpv_total:1031884,  pedidos_pro:0,  pedidos_smart:0, ativos_pro:0,   ativos_smart:0},
  {mes:"Jul/26",nivel:"Top Empreendedor",        resellers:0,  pedidos:0, ativos:0, tpv_m0:0,  tpv_m1:357639,  tpv_total:1982898,  pedidos_pro:0,  pedidos_smart:0, ativos_pro:0,   ativos_smart:0},
];

const DAILY = """ + daily_json + """;

const MES_ORDER=["Jan/26","Fev/26","Mar/26","Abr/26","Mai/26","Jun/26","Jul/26"];
...
// ── HELPERS ──
const MES_TO_YYYYMM={"Jan/26":"2026-01","Fev/26":"2026-02","Mar/26":"2026-03","Abr/26":"2026-04","Mai/26":"2026-05","Jun/26":"2026-06","Jul/26":"2026-07"};
const MES_LABEL={"2026-01":"Jan/26","2026-02":"Fev/26","2026-03":"Mar/26","2026-04":"Abr/26","2026-05":"Mai/26","2026-06":"Jun/26","2026-07":"Jul/26"};
...
const MES_PREFIX={"Jan/26":"2026-01","Fev/26":"2026-02","Mar/26":"2026-03","Abr/26":"2026-04","Mai/26":"2026-05","Jun/26":"2026-06","Jul/26":"2026-07"};
...
// ── SUBIDAS DE NÍVEL ──
const SUBIDAS_DETAIL = """ + subidas_json + """;

const QUEDAS_DETAIL = """ + quedas_json + """;
...
const MESES_NIVEIS = """ + meses_niveis_js + """;
...
function renderQuedas(){
  ...
  document.getElementById('cards-quedas').innerHTML=`
    ...
    ${TRANS_ORDER_Q.map(t=>`<div class="card" style="border-left-color:${TRANS_COLOR_Q[t]}">
      ...
      <div class="card-sub">""" + _niveis_periodo + """</div></div>`).join('')}`;
