...
const MESES_NIVEIS = ["2026-01","2026-02","2026-03","2026-04","2026-05"];
...
function renderNiveis(){
  ...
  document.getElementById('cards-niveis').innerHTML=`
    <div class="card"><div class="card-label">Total Subidas</div><div class="card-value">${total}</div><div class="card-sub">Jan–Mai/26</div></div>
    ${TRANS_ORDER.map(t=>`<div class="card" style="border-left-color:${TRANS_COLOR[t]}">
      ...
      <div class="card-sub">Jan–Mai/26</div></div>`).join('')}`;
